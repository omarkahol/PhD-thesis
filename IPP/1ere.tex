...
\newcommand{\PhDTitle}{Calibration bayésienne robuste et émulation de modèles informatiques complexes} 	%% Titre de la thèse / Thesis title
\newcommand{\PhDname}{M. Kahol Omar} 															%% Civilité, nom et prénom /  Civility, first name and name 
...
\newcommand{\PhDspeciality}{Ingénierie, mécanique et énergétique} 										%% Spécialité de doctorat / Speciality 
...
\newcommand{\defensedate}{08/10/2026} 															%% Date de soutenance / Date of defense
...
\newcommand{\logoEt}{polimi} 																%% Logo de l'université partenaire. Placer le fichier .png dans le répertoire '/media/etab' et indiquer le nom du fichier sans l'extension / Logo of partner university. Place the .png file in the directory '/media/etab' and point the file name without the extension
...
\newcommand{\jurynameA}{Josselin Garnier}
\newcommand{\juryadressA}{Professeur, École Polytechnique (CMAP)}
\newcommand{\juryroleA}{Président}

%%% Membre n°2 (Rapporteur) / Member n°2 (Reviewer)
\newcommand{\jurynameB}{Gianluigi Rozza}
\newcommand{\juryadressB}{Professeur, SISSA (mathLab)}
\newcommand{\juryroleB}{Rapporteur}

%%% Membre n°3 (Rapporteur) / Member n°3 (Reviewer)
\newcommand{\jurynameC}{Amandine Marrel}
\newcommand{\juryadressC}{Chercheuse, CEA Cadarache (IRESNE/DER)}
\newcommand{\juryroleC}{Rapporteur}

%%% Membre n°4 (Examinateur) / Member n°4 (Examiner)
\newcommand{\jurynameD}{Guillaume Perrin}
\newcommand{\juryadressD}{Chercheur, Université Gustave Eiffel / CEA DAM}
\newcommand{\juryroleD}{Examinateur}

%%% Membre n°5 (Directeur de thèse) / Member n°5 (Thesis supervisor)
\newcommand{\jurynameE}{Clémentine Prieur}
\newcommand{\juryadressE}{Professeure, Université Grenoble Alpes (LJK)}
\newcommand{\juryroleE}{Examinateur}

%%% Membre n°6 (Co-directeur de thèse) / Member n°6 (Thesis co-supervisor)
\newcommand{\jurynameF}{Pietro Marco Congedo}
\newcommand{\juryadressF}{Directeur de Recherche, Inria Saclay / CMAP}
\newcommand{\juryroleF}{Directeur de thèse}

%%% Membre n°7 (Invité) / Member n°7 (Guest)
\newcommand{\jurynameG}{Giulio Gori}
\newcommand{\juryadressG}{Professore Associato, Politecnico di Milano (DAER)}
\newcommand{\juryroleG}{Directeur de thèse}

%%% Membre n°8 (Invité) / Member n°8 (Guest)
\newcommand{\jurynameH}{Enora Denimal Goy}
\newcommand{\juryadressH}{Chargée de Recherche, Inria Saclay / CMAP}
