...
\newcommand{\PhDTitle}{Robust Bayesian Calibration and Emulation for Complex Computer Models} 	%% Titre de la thèse / Thesis title
\newcommand{\PhDname}{Omar Kahol} 															%% Civilité, nom et prénom /  Civility, first name and name 
...
\newcommand{\PhDspeciality}{Ingénierie mécanique} 										%% Spécialité de doctorat / Speciality 
